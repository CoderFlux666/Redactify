    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden font-outfit">
            ...
            <motion.div
                ...
                className="absolute top-0 left-0 w-[500px] h-[500px] bg-indigo-500/5 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2 pointer-events-none"
            />
            <motion.div
                animate={{
                    scale: [1, 1.1, 1],
                ...
                className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[100px] translate-x-1/2 translate-y-1/2 pointer-events-none"
            />
                ...
                <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.04)] border border-white/20 ring-1 ring-black/5">
                    <div className="text-center space-y-4 mb-8">
                        ...
                        >
                            ...
                            <p className="text-slate-500 text-sm mt-1">Sign in to your Redactify account</p>
                        </motion.div>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 text-slate-900 pl-11 pr-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder:text-slate-400 hover:bg-white hover:border-slate-300"
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-slate-900 text-white py-3.5 rounded-xl font-semibold hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed group"
                        >
                            {isLoading ? (
