            ...
            <div className="flex flex-col md:flex-row w-full max-w-5xl mx-auto p-4 z-10 items-center justify-center gap-12">
                ...
                >
                    ...
                    <h1 className="text-4xl font-bold text-slate-900 leading-tight">
                        Start Your Journey to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Secure Documents</span>
                    </h1>

                    <p className="text-lg text-slate-500">
                        Create an account to access our powerful AI redaction tools. It takes less than a minute to get started.
                    </p>
                </motion.div>
